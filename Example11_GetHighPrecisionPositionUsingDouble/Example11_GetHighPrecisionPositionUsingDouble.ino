...
void setup()
{
  ...
  //myGNSS.setNavigationFrequency(5, VAL_LAYER_RAM); //Set output to 5 times a second. Change the RAM layer only.
  ...
  delay(100);
  HC12.print("AT+C112"); //117 mag sensor
  delay(100);
  HC12.print("AT+P8");
  delay(100);
  digitalWrite(9, HIGH);
