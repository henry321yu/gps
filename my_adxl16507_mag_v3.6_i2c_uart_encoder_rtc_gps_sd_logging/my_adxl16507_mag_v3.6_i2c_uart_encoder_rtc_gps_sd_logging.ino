/*log
  ...
  2024/5/3 3.5 add rtc and date file name
*/
...
String logFileName, accdata, gyrdata, magdata, logdata, mag2data, tmdata, halldata, flydata, datedata, datadate; // Rotordata;
File logFile;
const int beeper = 4;
byte IMU507;
String mon, dayy;
...
const int H1 = 20, H2 = 21, H3 = 22, H4 = 23; //hall need wire
int setpin = 9;
...
void setup() {
  ...
  //datadate = String(year()) + String(month()) + String(day()) + String(hour()) + String(minute()) + String(second());
  mon = String(month());
  dayy = String(day());
  if (mon.length() < 2) {
    mon = "0" + mon;
...
void loop() {
  ...
  //halldata = String(position); //encoder
  halldata = String(analogRead(H1)) + "," + String(analogRead(H2)); //old hall
  ...
  logdata = String(timee, 3) + "," + datedata + ", " + accdata + "," + gyrdata + ", " + magdata + ", " + halldata + ", " + tmdata + ", " + String(f, 2) + ", " + String(delayy);
  ...
  flydata = String(timee, 3) + "," + String(ax, 7) + "," + String(ay, 3) + "," + String(az, 3) + "," + String(gx, 6) + "," + String(gy, 6) + "," + String(gz, 6) + "," + String(xm[1], 5) + "," + String(ym[1], 3) + "," + String(zm[1], 3) + "," + String(tempmonGetTemp(), 2) + "," + String(halldata) + "," + String(f, 1);
